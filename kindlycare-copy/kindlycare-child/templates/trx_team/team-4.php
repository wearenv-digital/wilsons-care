...
if ( !function_exists( 'kindlycare_template_team_4_theme_setup' ) ) {
	add_action( 'kindlycare_action_before_init_theme', 'kindlycare_template_team_4_theme_setup', 1 );
	function kindlycare_template_team_4_theme_setup() {
		kindlycare_add_template(array(
			'layout' => 'team-4',
			'template' => 'team-4',
			'mode'   => 'team',
			/*'container_classes' => 'sc_slider_nopagination sc_slider_controls sc_slider_controls_side',*/
			'title'  => esc_html__('Team /Style 4/', 'kindlycare'),
...
// Template output
if ( !function_exists( 'kindlycare_template_team_4_output' ) ) {
	function kindlycare_template_team_4_output($post_options, $post_data) {
		$show_title = true;
