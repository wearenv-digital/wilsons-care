...
if ( !function_exists( 'kindlycare_template_testimonials_2_theme_setup' ) ) {
	add_action( 'kindlycare_action_before_init_theme', 'kindlycare_template_testimonials_2_theme_setup', 1 );
	function kindlycare_template_testimonials_2_theme_setup() {
		kindlycare_add_template(array(
			...
			'title'  => esc_html__('Testimonials /Style 2/', 'kindlycare')
		));
	}
}

// Template output
if ( !function_exists( 'kindlycare_template_testimonials_2_output' ) ) {
	function kindlycare_template_testimonials_2_output($post_options, $post_data) {
		$show_title = true;
