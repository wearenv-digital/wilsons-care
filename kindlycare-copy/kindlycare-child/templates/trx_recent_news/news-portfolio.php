...
if ( !function_exists( 'kindlycare_template_news_portfolio_theme_setup' ) ) {
	add_action( 'kindlycare_action_before_init_theme', 'kindlycare_template_news_portfolio_theme_setup', 1 );
	function kindlycare_template_news_portfolio_theme_setup() {
		kindlycare_add_template(array(
			'layout' => 'news-portfolio',
			'template' => 'news-portfolio',
			'mode'   => 'news',
			'title'  => esc_html__('Recent News /Style Portfolio/', 'kindlycare'),
...
// Template output
if ( !function_exists( 'kindlycare_template_news_portfolio_output' ) ) {
	function kindlycare_template_news_portfolio_output($post_options, $post_data) {
