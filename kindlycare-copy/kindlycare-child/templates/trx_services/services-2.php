...
if ( !function_exists( 'kindlycare_template_services_2_theme_setup' ) ) {
	add_action( 'kindlycare_action_before_init_theme', 'kindlycare_template_services_2_theme_setup', 1 );
	function kindlycare_template_services_2_theme_setup() {
		kindlycare_add_template(array(
			'layout' => 'services-2',
			'template' => 'services-2',
			'mode'   => 'services',
			'need_columns' => true,
			'title'  => esc_html__('Services /Style 2/', 'kindlycare'),
...
// Template output
if ( !function_exists( 'kindlycare_template_services_2_output' ) ) {
	function kindlycare_template_services_2_output($post_options, $post_data) {
