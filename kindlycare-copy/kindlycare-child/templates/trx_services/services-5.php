...
if ( !function_exists( 'kindlycare_template_services_5_theme_setup' ) ) {
	add_action( 'kindlycare_action_before_init_theme', 'kindlycare_template_services_5_theme_setup', 1 );
	function kindlycare_template_services_5_theme_setup() {
		kindlycare_add_template(array(
			'layout' => 'services-5',
			'template' => 'services-5',
			'mode'   => 'services',
			'need_columns' => true,
			'title'  => esc_html__('Services /Style 5/', 'kindlycare'),
...
// Template output
if ( !function_exists( 'kindlycare_template_services_5_output' ) ) {
	function kindlycare_template_services_5_output($post_options, $post_data) {
