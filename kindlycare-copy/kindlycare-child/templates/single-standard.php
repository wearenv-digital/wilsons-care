...
if ( !function_exists( 'kindlycare_template_single_standard_theme_setup' ) ) {
	add_action( 'kindlycare_action_before_init_theme', 'kindlycare_template_single_standard_theme_setup', 1 );
	function kindlycare_template_single_standard_theme_setup() {
		kindlycare_add_template(array(
			'layout' => 'single-standard',
			'mode'   => 'single',
			'need_content' => true,
			'need_terms' => true,
			'title'  => esc_html__('Single standard', 'kindlycare'),
...
// Template output
if ( !function_exists( 'kindlycare_template_single_standard_output' ) ) {
	function kindlycare_template_single_standard_output($post_options, $post_data) {
